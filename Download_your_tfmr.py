...
if __name__ == '__main__':
    ...
    for file in filtered_repo_files:
        ...
        url = hf_hub_url(repo_id=repo_id, filename=file, repo_type="dataset")
        # 断点下载指令
        cmds.append(['wget','-T','60','-c',url,'-P',local_dir,'--no-check-certificate'])
...
'''
HF_ENDPOINT=https://hf-mirror.com python Download_your_tfmr.py --repo_id casehold/casehold --save_path /223040263/wanlong/casehold
'''