...
def get_args_parser():
    ...
    parser.add_argument("--lr_gate", default=5e-5, type=float)
    ...
    parser.add_argument("--memory_layers", default=12, type=int)


    # setting only for the situation when inference_only
    parser.add_argument('--inference_model_path', default="./exps/rams_large_/666/2e-5/checkpoint", type=str,
