...
def build_model(args, model_type):
    ...
    config.memory_layers = args.memory_layers
    ...
    if args.inference_only:
        ...
        new_lr = ['gate1.weight', 'gate2.weight']
        optimizer_grouped_parameters = [
            {'params': [p for n, p in model.named_parameters() if not any(nd in n for nd in (no_decay + new_lr)) ], 'weight_decay': args.weight_decay},
            {'params': [p for n, p in model.named_parameters() if any(nd in n for nd in no_decay)], 'weight_decay': 0.0},
            {'params': [p for n, p in model.named_parameters() if any(nd in n for nd in new_lr)], 'weight_decay': args.weight_decay, 'lr': args.lr_gate},
            ]
